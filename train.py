...
# функція для первинного завантаження даних (картинки)
def load_data():
...
model.fit(ds_train, epochs=epochs, validation_data=ds_test, verbose=1, steps_per_epoch = info.splits["train"].num_examples, validation_steps=info.splits["test"].num_examples, callbacks=tensorboard)
